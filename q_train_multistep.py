...
if __name__ == "__main__":
    ...
    for j in range(5):
        ...
        # Learning parameters
        lr = 5e-4  # Slightly lower increases stability at the cost of improvement speed
        eps_max = 0.99
        eps_min = 0.01
        ...
        while len(buffer) < buffer_size:
            ...
            while not done:
                ...
                state = next_state
            episode_buffer.compute_multistep_returns(n_multisteps)
            for exp in episode_buffer.buffer:
                buffer.append(exp)
